    ...
    >
      <div className="p-4 flex flex-col items-center text-center space-y-3">
        ...
        <div className="flex-1 min-h-[70px]">
          <h3 className="text-lg font-semibold text-foreground mb-1 line-clamp-1">{app.name}</h3>
        ...
        {isInstalled ? (
          <div className="w-full space-y-2">
            <Button
              ...
              className="w-full bg-primary hover:bg-primary/90 focus:ring-4 focus:ring-tv-focus h-11 text-sm"
              size="default"
            >
            ...
            <Button
              disabled
              className="w-full h-11 text-sm bg-green-600/20 text-green-400 border border-green-600/50 cursor-default"
              size="default"
            >
